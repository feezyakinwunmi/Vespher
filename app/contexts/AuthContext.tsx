...
//           setIsLoading(false);
//           setIsReady(true); // Set isReady to true after initial auth check
...
//         if (isActive) {
//           setIsLoading(false);
//           setIsReady(true); // Still set isReady true even on error
//           await SplashScreen.hideAsync();
//         }
//       }
//     };
...
//     // Check if user exists and get masked email
...
//     // Generate reset token (you can use Supabase's built-in reset)
//     const { error } = await supabase.auth.resetPasswordForEmail(email, {
//       redirectTo: 'vespher://reset-password', // Deep link for mobile
//     });
...
// // Update password with strong validation
